...
> **Вывод**: L-BFGS достигает минимального значения на обучающей выборке, но катастрофически переобучается. G-Hess — метод, сочетающий высокую скорость и устойчивое обобщение на линейных и логистических моделях.
